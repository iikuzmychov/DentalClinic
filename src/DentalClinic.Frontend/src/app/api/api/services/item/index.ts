...
// @ts-ignore
import { createGetServiceResponseFromDiscriminatorValue, createHttpValidationProblemDetailsFromDiscriminatorValue, serializeUpdateServiceRequest, type GetServiceResponse, type HttpValidationProblemDetails, type UpdateServiceRequest } from '../../../models/index';
// @ts-ignore
...
export interface ServicesItemRequestBuilder extends BaseRequestBuilder<ServicesItemRequestBuilder> {
     ...
     */
     put(body: UpdateServiceRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<void>;
    /**
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
