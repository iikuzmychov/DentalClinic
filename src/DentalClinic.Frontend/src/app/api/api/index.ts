...
// @ts-ignore
import { AppointmentsRequestBuilderNavigationMetadata, AppointmentsRequestBuilderRequestsMetadata, type AppointmentsRequestBuilder } from './appointments/index';
// @ts-ignore
import { AuthRequestBuilderNavigationMetadata, type AuthRequestBuilder } from './auth/index';
// @ts-ignore
import { PatientsRequestBuilderNavigationMetadata, PatientsRequestBuilderRequestsMetadata, type PatientsRequestBuilder } from './patients/index';
// @ts-ignore
import { ServicesRequestBuilderNavigationMetadata, ServicesRequestBuilderRequestsMetadata, type ServicesRequestBuilder } from './services/index';
// @ts-ignore
