...
// @ts-ignore
import { createAddAppointmentResponseFromDiscriminatorValue, createHttpValidationProblemDetailsFromDiscriminatorValue, createListAppointmentsResponseFromDiscriminatorValue, serializeAddAppointmentRequest, serializeAddAppointmentResponse, type AddAppointmentRequest, type AddAppointmentResponse, type HttpValidationProblemDetails, type ListAppointmentsResponse } from '../../models/index';
// @ts-ignore
import { AppointmentsItemRequestBuilderNavigationMetadata, AppointmentsItemRequestBuilderRequestsMetadata, type AppointmentsItemRequestBuilder } from './item/index';
// @ts-ignore
