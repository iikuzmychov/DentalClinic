...
// @ts-ignore
import { createHttpValidationProblemDetailsFromDiscriminatorValue, serializeCompleteAppointmentRequest, type CompleteAppointmentRequest, type HttpValidationProblemDetails } from '../../../../models/index';
// @ts-ignore
...
export interface CompleteRequestBuilder extends BaseRequestBuilder<CompleteRequestBuilder> {
     ...
     */
     post(body: CompleteAppointmentRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<void>;
    /**
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
