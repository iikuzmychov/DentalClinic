...
// @ts-ignore
import { createHttpValidationProblemDetailsFromDiscriminatorValue, createLoginResponseFromDiscriminatorValue, serializeLoginRequest, serializeLoginResponse, type HttpValidationProblemDetails, type LoginRequest, type LoginResponse } from '../../../models/index.js';
// @ts-ignore
...
export interface LoginRequestBuilder extends BaseRequestBuilder<LoginRequestBuilder> {
     ...
     * @throws {HttpValidationProblemDetails} error when the service returns a 401 status code
     */
...
export const LoginRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        errorMappings: {
            401: createHttpValidationProblemDetailsFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
